# Adds cached Dropbox URL fields to ELibraryModel and HardBookImage
# so thumbnail_url / image_url properties no longer call the Dropbox API on every page load.
